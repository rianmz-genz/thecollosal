...
import FeatureCard from "../components/molecules/Card/FeatureCard/index";
import { FiBox, FiCode, FiFigma } from "react-icons/fi";
      ...
      <section className="grid grid-cols-1 gap-6 sm:gap-8 place-items-center lg:grid-cols-2">
        ...
        <section className="grid grid-cols-1 gap-6 sm:gap-8 place-items-center lg:grid-cols-2">
          <aside className="text-center sm:w-10/12 lg:text-left lg:w-full">
            <div className="space-y-12 flex flex-col" data-aos="fade-right">
              <SectionSentence
